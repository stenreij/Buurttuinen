...
public class CommunityManager : MonoBehaviour
{
    ...
    CommunityGoal SelectUnusedGoal()
    {
        ...
        Debug.Log("Selected community goal: " + selected.goalType + " (used goals: " + usedGoalTypes.Count + "/" + possibleGoals.Count + ")");
